...
export const productsReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        ...
        case ADMIN_PRODUCTS_FAIL:
            return {
                loading: false,
                //in product action payload goes here
